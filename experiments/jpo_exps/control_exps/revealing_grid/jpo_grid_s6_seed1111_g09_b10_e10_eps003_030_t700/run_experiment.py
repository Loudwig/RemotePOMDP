...
from experiments.jpo_exps.control_exps.revealing_grid import (
...
EXPERIMENT["solver"]["initial_upper_bound"] = "fully_observable"
EXPERIMENT.pop("comparison_experiment", None)
