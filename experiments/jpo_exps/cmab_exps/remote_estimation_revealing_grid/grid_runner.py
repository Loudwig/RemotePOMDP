"""Shared resumable runner for the remote-estimation revealing grids."""
...
ROOT = Path(__file__).resolve().parent / "beta_00_05_10_15"

EXPERIMENT = {
    "name": "remote_estimation_beta_00_05_10_15",
    "grid_region": "anchor",
    "mdp_type": "cmab-estimation",
    "n_states": 6,
    "n_actions": 6,
    "density": 0.5,
    "mdp_seed": 1111,
